...
def compute_portvals(  		  	   		 	   			  		 			 	 	 		 		 	
    ...
    #
    #read data in 
    order = pd.read_csv(orders_file,index_col= 'Date')	
    ...
    symbol = order['Symbol'].unique().tolist()
    ...
    trades = pd.DataFrame(0, index=portvals.index,columns=portvals.columns )
    ...
    #storing the holding values by adding the previos holding value to the current  trade
